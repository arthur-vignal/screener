...
export function HeaderOverlay() {
  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 h-14 flex items-center justify-between pointer-events-auto">
        ...
        <div className="flex items-center gap-4 text-[12.5px] text-muted-foreground">
          ...
          <button
            ...
            className="ml-1 p-1.5 rounded-md hover:bg-white/5 transition-colors cursor-pointer"
