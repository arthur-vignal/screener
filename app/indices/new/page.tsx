          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full bg-canvas-soft border border-hairline rounded-md px-2 py-2 text-sm"
              >
                {UNIVERSES.map((u) => (
            ...
            <div>
              ...
              <input
                ...
                min={1}
                max={100}
                className="w-full bg-canvas-soft border border-hairline rounded-md px-3 py-2 text-sm font-mono"
              />
            </div>
          </div>
        ...
        <div className="rounded-lg border border-hairline bg-surface p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="px-3 py-1 text-xs rounded-md bg-surface-elevated/60 hover:bg-ink hover:text-canvas transition-colors disabled:opacity-50"
            >
          ...
          {preview ? (
            <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-6 gap-1.5">
              {preview.slice(0, 30).map((c) => (
                ...
                >
                  <span className="text-muted mr-1">#{c.rank}</span>
                  {c.symbol}
                </div>
              ))}
            </div>
